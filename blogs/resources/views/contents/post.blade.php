                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($posts as $post)
                                            <tr>
                                                ...
                                                <td class="cell"><span class="truncate">{{ $post->description }}</span>
                                                </td>
                                                <td class="cell">{{ $post->author }}</td>
                                                <td class="cell">
                                                    {{ Carbon\Carbon::parse($post->created_at)->format('d F Y') }}</td>
                                                <td class="cell">
                                                    <div class="d-flex">
                                                        <a class="btn-sm app-btn-secondary text-info" href="#">View</a>
                                                        <a class="btn-sm app-btn-secondary text-primary ms-1 me-1" href="#">Edit</a>
                                                        <a class="btn-sm app-btn-secondary text-danger" href="#">Delete</a>
                                                    </div>
                                                </td>
                                            </tr>
